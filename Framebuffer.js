export class Framebuffer {
    ...
    constructor(gl) {
       ...
       this.depthbufferTexture = gl.createTexture();
        ...
        // Unlit Buffer
        this.unlitbufferTexture = gl.createTexture();
        gl.bindTexture(gl.TEXTURE_2D,this.unlitbufferTexture);
        gl.texImage2D(gl.TEXTURE_2D,0,gl.RGB,gl.canvas.width,gl.canvas.height,0,gl.RGB,gl.UNSIGNED_BYTE,null);
        gl.texParameteri(gl.TEXTURE_2D,gl.TEXTURE_MIN_FILTER,gl.NEAREST);
        gl.texParameteri(gl.TEXTURE_2D,gl.TEXTURE_MAG_FILTER,gl.NEAREST);
        gl.framebufferTexture2D(gl.FRAMEBUFFER,gl.COLOR_ATTACHMENT2,gl.TEXTURE_2D,this.unlitbufferTexture,0);
        ...
        this.drawbuffers = [gl.COLOR_ATTACHMENT0,gl.COLOR_ATTACHMENT1,gl.COLOR_ATTACHMENT2];
